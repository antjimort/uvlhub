...
READ
'''
@notepad_bp.route('/notepad/<int:notepad_id>', method=['GET'])
@login_required
def get_notepad():
    notepad = notepad_service.get_by_id(notepad_id)
    return render_template('notepad/view.html', notepad=notepad)